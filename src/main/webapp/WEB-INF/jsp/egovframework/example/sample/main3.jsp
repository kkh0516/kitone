...
<meta name="keywords" content="재단소개, 문화공간, 문화예술정보뱅크, 문화예술DB, 아트레인, 자료실, 갤러리, 인천문화재단" />
...
<!-- 인천문화행사정보, 운영문화행사에 들어가는 js나 상단의 slick.js가 중복이라 주석처리함 -->
...
<div id="thema_wrapper" class="wrapper  ko" >
	...
	<div class="hd_top">
		<div class="at-container">
			<ul class="left_util">
				<li><a href="javascript:void(0);" style="background-color:chocolate">예술인e음카드</a></li>
				<li><a href="javascript:void(0);" style="background-color:chocolate">문화누리카드</a></li>
				<li class="link_ico"><a href="javascript:void(0);" style="background-color:chocolate" target="_blank" title="새창열림">인천문화통신 3.0</a></li>
			</ul>
			<ul class="right_util">
									<li>
						<div>
					...
					<li><a href="https://ifac.or.kr/member/member_check.php">회원가입</a></li>
												<li class="lang"><a href="javascript:void(0);" style="background-color:chocolate">ENGLISH</a></li>
			</ul>
		</div>
	</div>
	<script>
...
<div class="clearfix"></div>
	...
	<div class="clearfix"></div>
		...
		<img src="${pageContext.request.contextPath}/images/main3.png" alt="">
		<style>

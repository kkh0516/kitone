...
<meta name="title" content="2023년도 공연/전시 안내 > 인천문화재단" />
<meta name="subject" content="2023년도 공연/전시  안내" />
<meta name="publisher" content="인천문화재단" />
<meta name="author" content="인천문화재단" />
<meta name="robots" content="index,follow" />
<meta name="keywords" content="2023년도 공연/전시 안내, 공연/전시, 시설소개, 커뮤니티, 문화예술DB, 아트레인, 자료실, 프로그램/프로젝트, 인천문화재단" />
<meta name="description" content="2023년도 공연/전시 안내 아래 표는 모바일에서 좌우 동작을 지원합니다. 추진부서 사업명 사업내용 / 지원분야 공고(예정) 창작지원팀 예술창작 공연/전시 (舊 예술표현활동 지원) 일반 문학, 시각, 음악, 무용, 연극, 전통, 국제교류, 작은예술공간, 문화예술연구/비평 11월 집중(다년) 시각, 음악, 무용, 연극, 전통 신진/원로 문학, 시각, 음악, 무용…" />
<meta name="twitter:card" content="summary_large_image" />
<meta property="og:title" content="2023년도 공연/전시 안내 > 인천문화재단" />
...
<meta property="og:description" content="2023년도 공연/전시 안내 아래 표는 모바일에서 좌우 동작을 지원합니다. 추진부서 사업명 사업내용 / 지원분야 공고(예정) 창작지원팀 예술창작 공연/전시 (舊 예술표현활동 지원) 일반 문학, 시각, 음악, 무용, 연극, 전통, 국제교류, 작은예술공간, 문화예술연구/비평 11월 집중(다년) 시각, 음악, 무용, 연극, 전통 신진/원로 문학, 시각, 음악, 무용…" />
...
<div id="thema_wrapper" class="wrapper  ko" >
	...
	<div class="hd_top">
		<div class="at-container">
			<ul class="left_util">
				<li><a href="https://ifac.or.kr/IFACBBS/page.php?hid=Ifac_bg030702" style="background-color:#0d56b6;">예술인e음카드</a></li>
				<li><a href="https://ifac.or.kr/IFACBBS/page.php?hid=Ifac_bg220502" style="background-color:#0d56b6;">문화누리카드</a></li>
				<li class="link_ico"><a href="http://news2.ifac.or.kr/" target="_blank" title="새창열림"  style="background-color:#0d56b6;">인천문화통신 3.0</a></li>
			</ul>
			<ul class="right_util">
									<li>
						<div>
					...
					<li><a href="https://ifac.or.kr/member/member_check.php">회원가입</a></li>
												<li class="lang"><a href="https://ifac.or.kr/en" style="background-color:#0d56b6;" >ENGLISH</a></li>
			</ul>
		</div>
	</div>
	<script>
	...
	<header class="pc-header">
		<div class="at-container">
			...
			<div class="hd-logo">
				...
				<span class="tit" style="padding-left: 10px;border-left: 2px solid darkgray;margin-top: 15px;margin-left: 10px;float: right;color:#0d56b6;display:block;font-size:2.2rem;font-weight:700;">문화시설</span>
			</div>
			...
			<div class="hd_right_con">
				...
				<div class="">
					...
					<div class="header-search">
						<form name="tsearch" method="get" onsubmit="return tsearch_submit(this);" role="form" class="form" style="border: 3px solid #0d56b6;">
	...
	<nav class="at-menu" id="hd_menu_con">
		<!-- PC Menu -->
		<div class="pc-menu" style="background: #0d56b6;">
			

	<div class="nav-visible">
		<div class="at-container">
			<div class="nav-top nav-both nav-slide">
				<div class="menu-all-icon"  style="background: #0d56b6;" data-original-title="<nobr>사이트 맵</nobr>" data-toggle="tooltip" data-placement="top" data-html="true">
				...
				<ul class="menu-ul">
					<!-- <li class="menu-all-icon" data-original-title="<nobr>전체메뉴</nobr>" data-toggle="tooltip" data-placement="top" data-html="true">
						...
						<a class="menu-a nav-height" href="/menu2_1_1.do">
							시설소개												</a>
								...
								<ul class="sub-1dul">
									...
									<li class="menu-li on">
						<a class="menu-a nav-height" href="/menu2_2_1.do">
							공연/전시											</a>
													<div class="sub-slide sub-1div">
								<ul class="sub-1dul">
									...
									<li class="menu-li off">
						<a class="menu-a nav-height" href="/menu2_3_1.do">
							교육/행사													</a>
													<div class="sub-slide sub-1div">
								<ul class="sub-1dul">
									...
									<li class="menu-li off">
						<a class="menu-a nav-height" href="/menu2_4_1.do">
							대관신청													</a>
													<div class="sub-slide sub-1div">
								<ul class="sub-1dul">
									...
									<li class="menu-li off">
						<a class="menu-a nav-height" href="/menu2_5_1.do">
							커뮤니티													</a>
													<div class="sub-slide sub-1div">
								<ul class="sub-1dul">
								<li class="sub-1dli off">
									...
									<li class="menu-li off">
						<a class="menu-a nav-height" href="/menu2_6_1.do">
							레지던시													</a>
													<div class="sub-slide sub-1div">
								<ul class="sub-1dul">
									...
									<li class="menu-li off">
						<a class="menu-a nav-height" href="/menu2_7_1.do">
							프로그램/프로젝트												</a>
													<div class="sub-slide sub-1div">
								<ul class="sub-1dul">
...
<div class="clearfix"></div>
	...
	<div class="clearfix"></div>
			...
			<div class="at-title at-title_bg_4">
			<div class="at-container">
					...
					<div class="col-md-9 pull-right at-col at-main">
						<div class="page_top">
							<span class="page_top_nav">
								...
								<span>시설소개</span>
								 <strong><span class="nav_last">한국근대문학관 소개</span></strong>															</span>
...
<div class="page-content">
	<img src="${pageContext.request.contextPath}/images/menu2_1_1.png" alt="">
</div>

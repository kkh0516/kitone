...
<meta name="keywords" content="재단소개, 공연/전시, 커뮤니티, 문화예술DB, 아트레인, 자료실, 갤러리, 인천문화재단" />
...
<div id="thema_wrapper" class="wrapper  ko" >
	...
	<div class="hd_top">
		<div class="at-container">
			<ul class="left_util">
				<li><a href="javascript:void(0);" style="background-color:#0d56b6;">예술인e음카드</a></li>
				<li><a href="javascript:void(0);" style="background-color:#0d56b6;">문화누리카드</a></li>
				<li class="link_ico"><a href="javascript:void(0);" style="background-color:#0d56b6;" target="_blank" title="새창열림">인천문화통신 3.0</a></li>
			</ul>
			<ul class="right_util">
									<li>
						<div>
					...
					<li><a href="https://ifac.or.kr/member/member_check.php">회원가입</a></li>
												<li class="lang"><a href="javascript:void(0);" style="background-color:#0d56b6;">ENGLISH</a></li>
			</ul>
		</div>
	</div>
	<script>
...
<div class="clearfix"></div>
	...
	<div class="clearfix"></div>
		...
		<img src="${pageContext.request.contextPath}/images/main2.png" alt="" style="width: 100%;>
		<style>

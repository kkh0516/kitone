...
<meta name="keywords" content="2023년도 문화행사 안내, 문화행사, 소개, 청년플랫폼, 문화예술DB, 아트레인, 자료실, 문화기록물, 인천문화재단" />
...
<div id="thema_wrapper" class="wrapper  ko" >
	...
	<div class="hd_top">
		<div class="at-container">
			<ul class="left_util">
				<li><a href="https://ifac.or.kr/IFACBBS/page.php?hid=Ifac_bg030702" style="background-color:darkmagenta;">예술인e음카드</a></li>
				<li><a href="https://ifac.or.kr/IFACBBS/page.php?hid=Ifac_bg220502" style="background-color:darkmagenta;">문화누리카드</a></li>
				<li class="link_ico"><a href="http://news2.ifac.or.kr/" target="_blank" title="새창열림"  style="background-color:darkmagenta;">인천문화통신 3.0</a></li>
			</ul>
			<ul class="right_util">
									<li>
						<div>
					...
					<li><a href="https://ifac.or.kr/member/member_check.php">회원가입</a></li>
												<li class="lang"><a href="https://ifac.or.kr/en" style="background-color:darkmagenta;" >ENGLISH</a></li>
			</ul>
		</div>
	</div>
	<script>
	...
	<header class="pc-header">
		<div class="at-container">
			...
			<div class="hd-logo">
				...
				<span class="tit" style="padding-left: 10px;border-left: 2px solid darkgray;margin-top: 15px;margin-left: 10px;float: right;color:darkmagenta;display:block;font-size:2.2rem;font-weight:700;">아카이브</span>
			</div>
			...
			<div class="hd_right_con">
				...
				<div class="">
					...
					<div class="header-search">
						<form name="tsearch" method="get" onsubmit="return tsearch_submit(this);" role="form" class="form" style="border: 3px solid darkmagenta;">
	...
	<nav class="at-menu" id="hd_menu_con">
		<!-- PC Menu -->
		<div class="pc-menu" style="background: darkmagenta;">
			

	<div class="nav-visible">
		<div class="at-container">
			<div class="nav-top nav-both nav-slide">
				<div class="menu-all-icon"  style="background: darkmagenta;" data-original-title="<nobr>사이트 맵</nobr>" data-toggle="tooltip" data-placement="top" data-html="true">
				...
				<ul class="menu-ul">
					<!-- <li class="menu-all-icon" data-original-title="<nobr>전체메뉴</nobr>" data-toggle="tooltip" data-placement="top" data-html="true">
						...
						<a class="menu-a nav-height" href="/menu5_1_1.do">
							문화유산												</a>
								...
								<ul class="sub-1dul">
									...
									<li class="menu-li on">
						<a class="menu-a nav-height" href="/menu5_2_1.do">
							예술인정보											</a>
													<div class="sub-slide sub-1div">
								<ul class="sub-1dul">
									...
									<li class="menu-li off">
						<a class="menu-a nav-height" href="/menu5_3_1.do">
							기록물													</a>
													<div class="sub-slide sub-1div">
								<ul class="sub-1dul">
									...
									<li class="menu-li off">
						<a class="menu-a nav-height" href="/menu5_4_1.do">
							도서/사진/영상												</a>
													<div class="sub-slide sub-1div">
								<ul class="sub-1dul">
									...
									<li class="menu-li off">
						<a class="menu-a nav-height" href="/menu5_5_1.do">
							작품													</a>
													<div class="sub-slide sub-1div">
								<ul class="sub-1dul">
								<li class="sub-1dli off">
						...
						<li class="menu-li off">
						<a class="menu-a nav-height" href="/menu5_6_1.do">
							간행물													</a>
													<div class="sub-slide sub-1div">
								<ul class="sub-1dul">
								<li class="sub-1dli off">
						...
						<li class="menu-li off">
						<a class="menu-a nav-height" href="/menu5_7_1.do">
							뉴스레터													</a>
													<div class="sub-slide sub-1div">
								<ul class="sub-1dul">
								<li class="sub-1dli off">
...
<div class="clearfix"></div>
	...
	<div class="clearfix"></div>
			...
			<div class="at-title at-title_bg_6">
			<div class="at-container">
		...
		<div class="at-body at-body-L_menu" id="content_at_body"> <!-- 서브페이지 상당 라인 bg를 위해 at-body-L_menu 추가-->
					...
					<div class="col-md-9 pull-right at-col at-main">
						<div class="page_top">
							<span class="page_top_nav">
								...
								<span>소개</span>
								 <strong><span class="nav_last">소메뉴1</span></strong>															</span>
					...
					<div class="page-wrap">
			<div class="pg_title nanum">소메뉴1</div>
...
<div class="page-content">
    <p class="square_tit nanum">2023년도 문화행사 안내</p>

    <div class="table-responsive">
        <p class="tb_mo_txt">&nbsp;아래 표는 모바일에서 좌우 동작을 지원합니다.</p>
        <table width="100%" class="N_table_01">
            <colgroup>
                <col width="10%" />
                <col width="13%" />
                <col width="12%" />
            ...
            <thead>
                <tr>
                    ...
                    <th colspan="2">사업명</th>
                    <th>사업내용 / 지원분야</th>
                    <th class="nbdr">공고<br />(예정)</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td rowspan="7">창작지원팀</td>
					<td rowspan="3">예술창작 <br />문화행사 <br /></br>(舊 예술표현활동 지원)</td>
					<td>일반</td>
					<td class="tal">문학, 시각, 음악, 무용, 연극, 전통, 국제교류, 작은예술공간, 문화예술연구/비평</td>
					<td rowspan="2" class="nbdr">11월</td>
                </tr>
				<tr>
					<td>집중(다년)</td>
					<td class="tal">시각, 음악, 무용, 연극, 전통</td>
                </tr>
				<tr>
					<td>신진/원로</td>
					<td class="tal">문학, 시각, 음악, 무용, 연극, 전통</td>
					<td class="nbdr">5월</td>
                </tr>
				<tr>
					<td colspan="2">공연장상주단체육성지원</td>
					<td class="tal">인천 내 공연장과 공연예술단체의 매칭 지원</td>
					<td class="nbdr">11월</td>
				</tr>
				<tr>
					<td colspan="2">미술활성화기획</td>
					<td class="tal">인천 연고 시각예술 작가의 작품 구입 및 미술품 대여, 전시 사업</td>
					<td class="nbdr">5월</td>
				</tr>
				<tr>
					<td colspan="2">문화예술특화거리</td>
					<td class="tal">지역거점 창작공간 및 활동 지원</td>
					<td class="nbdr">5월</td>
				</tr>
				<tr>
					<td colspan="2">청년문화예술특화거리</td>
					<td class="tal">지역거점 청년 창작공간 및 활동지원</td>
					<td class="nbdr">5월</td>
				</tr>
				<tr>
					<td rowspan="4">지역문화팀</td>
					<td rowspan="2" colspan="2">문화기획프로젝트 [시민 X] <br />(舊 시민문화활동지원)</td>
					<td class="tal">[거점형] <br />생활 속 문화공간을 기반으로 한 시민 주체 문화 활동 기획 지원</td>
					<td rowspan="2" class="nbdr">3~4월</td>
				</tr>
				<tr>
					<td class="tal">[활동형] <br />문화다양성 및 생활형 이슈를 주제로 한 시민 참여형 활동 기획 지원</td>
				</tr>
				<tr>
					<td colspan="2">생활문화동아리 활동 지원</td>
					<td class="tal">생활문화동아리 활동 지원(자체 모임 및 발표, 교육을 위한 강사비 등), 사회공헌 활동지원</td>
					<td class="nbdr">3~4월</td>
				</tr>
				<tr>
					<td colspan="2">찾아가는 문화활동 <br />(섬마을 문화살롱) 지원</td>
					<td class="tal">강화군, 옹진군에 위치한 문화활동이 어려운 시설 및 계층에게 문화예술단체가 직접 방문하여 문화예술프로그램 제공(희망지역/시설과 프로그램 매칭) </td>
					<td class="nbdr">3~4월</td>
				</tr>
				<tr>
					<td rowspan="5">문화예술 <br />교육지원 <br />센터</td>
					<td rowspan="2">인천문화예술교육 기획 지원 (지역특성화)</td>
					<td>거점구축</td>
					<td class="tal">문화예술교육 거점 조성 활동비 및 프로그램 개발·운영비 지원</td>
					<td rowspan="2" class="nbdr">2월</td>
				</tr>
				<tr>
					<td>프로그램개발</td>
					<td class="tal">주제 중심 문화예술교육 프로그램 개발·운영비 지원</td>
				</tr>
				<tr>
					<td colspan="2">인천 꿈다락 문화예술학교</td>
					<td class="tal">시민(전 생애) 대상 문화예술교육 프로그램 운영비 지원</td>
					<td class="nbdr">2월</td>
				</tr>
				<tr>
					<td colspan="2">유아 문화예술교육 지원 <br />&lt;아이와락-인천&gt;</td>
					<td class="tal">유아 대상 문화예술교육 프로그램 연구개발 및 운영비 지원(문화자원연계)</td>
					<td class="nbdr">2월</td>
				</tr>
				<tr>
					<td colspan="2">문화예술교육사 현장역량강화 사업</td>
					<td class="tal">문화자원에 문화예술교육사 인건비, 프로그램 운영비 지원</td>
					<td class="nbdr">2월</td>
				</tr>
				<tr>
					<td rowspan="4">청년문화팀</td>
					<td colspan="2">청년문화축제지원</td>
					<td class="tal">청년 예술인이 주도하는 과정 중심의 축제 활동 지원</td>
					<td class="nbdr">7월</td>
				</tr>
				<tr>
					<td colspan="2">청년창작활성화지원</td>
					<td class="tal">청년예술인 및 기획자의 활동을 위한 다양한 문화행사 추진 준비단계 지원, 청년창작자·기획자·연구 지원, 국제교류 지원, 자립지원 등 창작활동 입체적 지원</td>
					<td class="nbdr">5월</td>
				</tr>
				<tr>
					<td colspan="2">청년역량강화</td>
					<td class="tal">청년 창작자들의 역량강화를 위한 강의, 워크숍, 특강 등의 교육프로그램 운영 지원</td>
					<td class="nbdr">7월</td>
				</tr>
				<tr>
					<td colspan="2">청년문화공간 활성화</td>
					<td class="tal">
						지역 거점 청년예술인의 공간거점사업 운영<br />
						청년예술가 개별 프로젝트 진행 및 청년 예술가 간 협력 프로젝트 진행
					</td>
					<td class="nbdr">3월</td>
				</tr>
            </tbody>
...
<div class="widget-side">
			...
			<div class="side-title nanum" style="background:darkmagenta;">
			작품		</div>
